...
if(dataTree$errMsg == "") {
  ...
  if(errMsg == "") {
    ...
    crossEfficiency <- calculateCrossEfficiencyForAll(dmuData, dmuData$transformToUtilities)
	#print(crossEfficiency)
    saveResult(dmuData$altIDs, crossEfficiency, "crossEfficiency")
