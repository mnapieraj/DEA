...
if(dataTree$errMsg == "") {
  ...
  if(errMsg == "") {
	...
	source("pairwiseComparisonsSMAA.R")
	compSMAA <- calculateComparisonsSMAAForAll(dmuData, dmuData$samplesNo)
	#print(compSMAA)
    saveResult(dmuData$altIDs, compSMAA, "pairwiseOutrankingIndices")
